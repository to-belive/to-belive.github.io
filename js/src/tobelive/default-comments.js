...
var NOT_INITIALIZED_ERROR = exports.NOT_INITIALIZED_ERROR = new Error('请初始化评论系统');
...
function renderHeader(_ref, instance) {
  ...
  likeButton.innerHTML = '\n    ' + _icons.heart + '\n    ' + (likedReaction ? '不喜欢' : '喜欢') + '\n    ' + (meta.reactions && meta.reactions.heart ? ' \u2022 <strong>' + meta.reactions.heart + '</strong> 我喜欢' : '') + '\n  ';
...
function renderComments(_ref2, instance) {
  ...
  if (error) {
    ...
    emptyBlock.innerText = '暂无评论，成为第一个评论的人吧';
  ...
  comments.forEach(function (comment) {
    ...
    updateDate = updateDate.getFullYear() + "-" + (updateDate.getMonth() + 1) + "-" + (updateDate.getDay()) + " " + updateDate.getHours() + ":" + updateDate.getMinutes() + ":" + updateDate.getSeconds()
    var commentItem = document.createElement('li');
    commentItem.className = 'gitment-comment';
    commentItem.innerHTML = '\n      <a class="gitment-comment-avatar" href="' + comment.user.html_url + '" target="_blank">\n        <img class="gitment-comment-avatar-img" src="' + comment.user.avatar_url + '"/>\n      </a>\n      <div class="gitment-comment-main">\n        <div class="gitment-comment-header">\n          <a class="gitment-comment-name" href="' + comment.user.html_url + '" target="_blank">\n            ' + comment.user.login + '\n          </a>\n          评论于          <span title="' + createDate + '">' + createDate + '</span>\n          ' + (createDate !== updateDate ? ' \u2022 <span title="comment was edited at ' + updateDate + '">修改于</span>' : '') + '\n          <div class="gitment-comment-like-btn">' + _icons.heart + ' ' + (comment.reactions.heart || '') + '</div>\n        </div>\n        <div class="gitment-comment-body gitment-markdown">' + comment.body_html + '</div>\n      </div>\n    ';
...
function renderEditor(_ref3, instance) {
  ...
  previewTab.onclick = function () {
    ...
    if (!content) {
      preview.innerText = '暂无任何评论';
      return;
    }

    preview.innerText = '评论系统加载中...';
...
function renderFooter() {
  ...
  container.innerHTML = '\n    由    <a class="gitment-footer-project-link" href="https://github.com/imsun/gitment" target="_blank">\n      Gitment\n    </a> 强力驱动 \n ● <a href="http://tobelive.cn"> 乔治小叔 </a> 汉化';
  return container;
}
